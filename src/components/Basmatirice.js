    ...
    <>
        ...
        <div className="container">
          <div className="row head-product d-flex justify-content-space-between align-items-center">
            ...
            <div className="col-sm-7 col-xs-12 text-sm-end first-text-product  first-text-product2">
              ...
              <MdOutlineKeyboardArrowRight></MdOutlineKeyboardArrowRight>
              <Link to="/inadianrice"> {props.maintitle}</Link>
              <MdOutlineKeyboardArrowRight></MdOutlineKeyboardArrowRight>
      ...
      <div className="main-basmati-box">
        <div className="row mt-3 row-box">
          <div className="col-lg-5 col-md-6 col-sm-7 basmti-main-img">
          ...
          <div className="col-lg-7 col-md-6 col-sm-5">
            <div className="basmati-body">
              <p className="fn-26">{props.title}</p>
             ...
             <span className="mt-gray-text">MOQ : </span>
              ...
              <div id="box-btn" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                    <div className="brbtn1"> REQUEST TO CALL </div>
                                  </div>
              </div>
              <div className="col-md-6 col-sm-12 p-0"> <div className="brbtn2">SEND ENQUIRY</div></div>
      ...
      <div id="basmati-table">
        ...
        <div className="main-basmati-box">
          <div className="row mt-5">
            <div className="col-12 pt-4 main-line-text">
              <h5 className="gray-text">Product Details</h5>
            </div>
            <div className="col-md-6 col-sm-12 main-line">
                  ...
                  <div className="modal-dialog">
                    <div className="modal-content">
                      <div className="modal-body">
                        <div className="row">
                          <div className="col-sm-5 col-xs-11">
                            <div className="back-img back-img-box bg1">
                              ...
                              <img
                                ...
                                alt=""
                              />
                              <p className="title-interested pb-2">
                                {props.title}
                              </p>
                            </div>
                            <div className="fs">
                              <div className="text-gray">
                                <p className="ps-2 mt-3">MOQ : 24 Ton</p>
                              </div>
                              <p className="text-gray pt-2 m-0">
                                <b className="ps-2">Preferred Buyer From</b>
                              </p>
                              <p className="text-gray ps-2 pt-2 mt-0 m-0">
                                Location :
                                <span className="text-gray "> Worldwide</span>
                              </p>
                            </div>
                          </div>
                          <div className="col-sm-7 col-xs-11">
                            <p className="title-interested2 pb-2">
                              ...
                              <div className="row">
                                <div className="col-md-12 col-sm-12">
                                  <div className="main-box d-flex">
                                    <div className="inpute-name1 in gray-text">
                                      <label className="name">Name </label>
                                    </div>
                                    <div className="input-main-name">
                                      <input className="inpute-name-box1" type="name" onChange={(e) => setname(e.target.value)} placeholder="Enter Name"
                                        required
                                      />
                                      <span>{error}</span>
                                    </div>
                                ...
                                <div className="col-sm-12">
                                  <div className="main-box main-box2 d-flex">
                                    <div className="inpute-name1 in gray-text">
                                      <label className="name">
                                        Purpose of Requirement
                                      </label>
                                    </div>
                                    <div className="input-main-name inpute-name-box1 d-flex">
                                      <div className="radio-box radio-box1 box fs">
                                        <input
                                          className="fs"
                                          type="radio"
                                          name="1"
                                ...
                                <div className="col-sm-12">
                                  <div
                                    ...
                                    data-bs-target="#exampleModal"
                                  >
                                    <inpute type="submit" onClick={()=>{Validation()}} className="box-btn mr-auto">
                                      SEND ENQUIRY
                                    </inpute>
                                  </div>
                                </div>
      ...
      <div className="container">
        <div className="main-basmati-box  mt-5 ">
          <div className="row ">
            <div className="col-12 pt-3 text-center">
              <h3>
                Looking for"<span className="rf"><b>{props.title}</b></span>"?
              </h3>
            </div>
            <div className="row">
              ...
              <div className="col-sm-12">
                <div className="main-box1 main-box2 d-flex">
                  <div className="inpute-name1 in gray-text">
                    <label className="name">Purpose of Requirement</label>
                  </div>
                  <div className="input-main-name inpute-name-box1 d-flex">
                    <div className="radio-box box fs">
                      <input
                        className="fs"
                        type="radio"
                        name="1"
              ...
              <div className="col-sm-12 mb-4">
                <div id="box-btn">
                  <div className="box-btn mr-auto">SEND ENQUIRY</div>
                </div>
              </div>
            </div>
          </div>
...
{/* 
        ...
        <Link to="/sesameseeds " title="Grains ">
            <div className="single-product-slider ">
                <div className="back-img-slider hidden">
                    <img className="product-2" src={require("../imgs/asset 42.jpeg")} alt="" />
                </div>
            <div id="basmati-btn-last">
                <b className="silder-text text-center">Sesame Seeds </b> 
                <div className="brbtn2 btn-slider mt-3"> Get Best Quote </div>
        ...
        <Link to="/sesameseeds " title="Grains ">
            <div className="single-product-slider ">
                <div className="back-img-slider hidden">
                    <img className="product-2" src={require("../imgs/asset 43.jpeg")} alt="" />
                </div>
            <div id="basmati-btn-last">
                <b className="silder-text text-center">Sesame Seeds </b> 
                <div className="brbtn2 btn-slider mt-3"> Get Best Quote </div>
        ...
        <Link to="/sesameseeds " title="Grains ">
            <div className="single-product-slider ">
                <div className="back-img-slider hidden">
                    <img className="product-2" src={require("../imgs/asset 44.jpeg")} alt="" />
                </div>
            <div id="basmati-btn-last">
                <b className="silder-text text-center">Sesame Seeds </b> 
                <div className="brbtn2 btn-slider mt-3"> Get Best Quote </div>
        ...
        <Link to="/sesameseeds " title="Grains ">
            <div className="single-product-slider ">
                <div className="back-img-slider hidden">
                    <img className="product-2" src={require("../imgs/asset 45.jpeg")} alt="" />
                </div>
            <div id="basmati-btn-last">
                <b className="silder-text text-center">Sesame Seeds </b> 
                <div className="brbtn2 btn-slider mt-3"> Get Best Quote </div>
        ...
        <Link to="/sesameseeds " title="Grains ">
            <div className="single-product-slider ">
                <div className="back-img-slider hidden">
                    <img className="product-2" src={require("../imgs/asset 46.jpeg")} alt="" />
                </div>
            <div id="basmati-btn-last">
                <b className="silder-text text-center">Sesame Seeds </b> 
                <div className="brbtn2 btn-slider mt-3"> Get Best Quote </div>
        ...
        <Link to="/sesameseeds " title="Grains ">
            <div className="single-product-slider ">
                <div className="back-img-slider hidden">
                    <img className="product-2" src={require("../imgs/asset 47.jpeg")} alt="" />
                </div>
            <div id="basmati-btn-last">
                <b className="silder-text text-center">Sesame Seeds </b> 
                <div className="brbtn2 btn-slider mt-3"> Get Best Quote </div>
        ...
        <Link to="/sesameseeds " title="Grains ">
            <div className="single-product-slider ">
                <div className="back-img-slider hidden">
                    <img className="product-2" src={require("../imgs/asset 48.jpeg")} alt="" />
                </div>
            <div id="basmati-btn-last">
                <b className="silder-text text-center">Sesame Seeds </b> 
                <div className="brbtn2 btn-slider mt-3"> Get Best Quote </div>
        ...
        <Link to="/sesameseeds " title="Grains ">
            <div className="single-product-slider ">
                <div className="back-img-slider hidden">
                    <img className="product-2" src={require("../imgs/asset 49.jpeg")} alt="" />
                </div>
            <div id="basmati-btn-last">
                <b className="silder-text text-center">Sesame Seeds </b> 
                <div className="brbtn2 btn-slider mt-3"> Get Best Quote </div>
        ...
        <Link to="/sesameseeds " title="Grains ">
            <div className="single-product-slider ">
                <div className="back-img-slider hidden">
                    <img className="product-2 w-100" src={require("../imgs/asset 51.jpeg")} alt="" />
                </div>
            <div id="basmati-btn-last">
                <b className="silder-text text-center">Sesame Seeds </b> 
                <div className="brbtn2 btn-slider mt-3"> Get Best Quote </div>
        ...
        <Link to="/sesameseeds " title="Grains ">
            <div className="single-product-slider ">
                <div className="back-img-slider hidden">
                    <img className="product-2" src={require("../imgs/asset 52.jpeg")} alt="" />
                </div>
            <div id="basmati-btn-last">
                <b className="silder-text text-center">Sesame Seeds </b> 
                <div className="brbtn2 btn-slider mt-3"> Get Best Quote </div>
        ...
        <Link to="/sesameseeds " title="Grains ">
            <div className="single-product-slider ">
                <div className="back-img-slider hidden">
                    <img className="product-2" src={require("../imgs/asset 53.jpeg")} alt="" />
                </div>
            <div id="basmati-btn-last">
                <b className="silder-text text-center">Sesame Seeds </b> 
                <div className="brbtn2 btn-slider mt-3"> Get Best Quote </div>
        ...
        <Link to="/sesameseeds " title="Grains ">
            <div className="single-product-slider ">
                <div className="back-img-slider hidden">
                    <img className="product-2 w-100" src={require("../imgs/asset 54.jpeg")} alt="" />
                </div>
            <div id="basmati-btn-last">
                <b className="silder-text text-center">Sesame Seeds </b> 
                <div className="brbtn2 btn-slider mt-3"> Get Best Quote </div>
        ...
        <Link to="/sesameseeds " title="Grains ">
            <div className="single-product-slider ">
                <div className="back-img-slider hidden">
                    <img className="product-2 w-100" src={require("../imgs/asset 55.jpeg")} alt="" />
                </div>
            <div id="basmati-btn-last">
                <b className="silder-text text-center">Sesame Seeds </b> 
                <div className="brbtn2 btn-slider mt-3"> Get Best Quote </div>
        ...
        <Link to="/sesameseeds " title="Grains ">
            <div className="single-product-slider ">
                <div className="back-img-slider hidden">
                    <img className="product-2" src={require("../imgs/asset 56.jpeg")} alt="" />
                </div>
            <div id="basmati-btn-last">
                <b className="silder-text text-center">Sesame Seeds </b> 
                <div className="brbtn2 btn-slider mt-3"> Get Best Quote </div>
        ...
        <Link to="/sesameseeds " title="Grains ">
            <div className="single-product-slider ">
                <div className="back-img-slider hidden">
                    <img className="product-2" src={require("../imgs/asset 57.jpeg")} alt="" />
                </div>
            <div id="basmati-btn-last">
                <b className="silder-text text-center">Sesame Seeds </b> 
                <div className="brbtn2 btn-slider mt-3"> Get Best Quote </div>
        ...
        <Link to="/sesameseeds " title="Grains ">
            <div className="single-product-slider ">
                <div className="back-img-slider hidden">
                    <img className="product-2" src={require("../imgs/asset 58.jpeg")} alt="" />
                </div>
            <div id="basmati-btn-last">
                <b className="silder-text text-center">Sesame Seeds </b> 
                <div className="brbtn2 btn-slider mt-3"> Get Best Quote </div>
        ...
        <Link to="/sesameseeds " title="Grains ">
            <div className="single-product-slider ">
                <div className="back-img-slider hidden">
                    <img className="product-2" src={require("../imgs/asset 59.jpeg")} alt="" />
                </div>
            <div id="basmati-btn-last">
                <b className="silder-text text-center">Sesame Seeds </b> 
                <div className="brbtn2 btn-slider mt-3"> Get Best Quote </div>
        ...
        <Link to="/sesameseeds " title="Grains ">
            <div className="single-product-slider ">
                <div className="back-img-slider hidden">
                    <img className="product-2 w-100" src={require("../imgs/asset 60.jpeg")} alt="" />
                </div>
            <div id="basmati-btn-last">
                <b className="silder-text text-center">Sesame Seeds </b> 
                <div className="brbtn2 btn-slider mt-3"> Get Best Quote </div>
        ...
        <Link to="/sesameseeds " title="Grains ">
            <div className="single-product-slider ">
                <div className="back-img-slider hidden">
                    <img className="product-2 w-100" src={require("../imgs/asset 61.jpeg")} alt="" />
                </div>
            <div id="basmati-btn-last">
                <b className="silder-text text-center">Sesame Seeds </b> 
                <div className="brbtn2 btn-slider mt-3"> Get Best Quote </div>
        ...
        <Link to="/sesameseeds " title="Grains ">
            <div className="single-product-slider ">
                <div className="back-img-slider hidden">
                    <img className="product-2 w-100" src={require("../imgs/asset 62.jpeg")} alt="" />
                </div>
            <div id="basmati-btn-last">
                <b className="silder-text text-center">Sesame Seeds </b> 
                <div className="brbtn2 btn-slider mt-3"> Get Best Quote </div>
